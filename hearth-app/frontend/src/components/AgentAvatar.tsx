...
// Ported from Healthcare-EPIC-Snowflake-Demo for Hearth QSR palette.
...
export default function AgentAvatar({ agent, systemColor = '#b87333', active = false, size = 40, from }: Props) {
  ...
  return (
    <span
      ...
      style={{
        ...
        borderRadius: 4,
        background: 'rgba(60,40,23,0.45)',
        border: `1.5px solid ${active ? color : 'rgba(60,40,23,0.7)'}`,
